...
function useFrameProcessor(frameProcessor: FrameProcessor, dependencies: DependencyList): FrameProcessor {
...
const useBarcodeScanner = (format: BarcodeScannerFormats): [BarcodeData | undefined, FrameProcessor] => {
  ...
  const frameProcessor = useFrameProcessor((frame: any) => {
    ...
    */
    data == null ? runOnJS(setBarcodeData)(undefined) : runOnJS(setBarcodeData)(data)
  }, [])
